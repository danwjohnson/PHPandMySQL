...
// This function returns an array--month, day, year--if valid.
...
if (isset($_POST['start'], $_POST['end'])) {
    ...
    if ( (list($sm, $sd, $sy) = validate_date($_POST['start'])) && (list($em, $ed, $ey) =
        ...
        // If it's okay, adjust the DateTime object:
        ...
        if ($start < $end ) {
            ...
            // Print the results:
            echo "<p>The event has been planned start on {$start->format($format)} and ending
