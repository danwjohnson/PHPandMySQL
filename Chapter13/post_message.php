...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $dbc = mysqli_connect ('127.0.0.1', 'phpusr', 'phpusr', 'forum');
    ...
    // Bind the variables
    mysqli_stmt_bind_param($stmt, 'iiiss', $forum_id, $parent_id, $user_id,
                           $subject, $body);
    ...
    if (mysqli_stmt_affected_rows($stmt) == 1) {
        ...
        echo '<p style="font-weight: bold; color: #C00">Your message could not
        be posted.</p>';
...
<form action="post_message.php" method="post">
    ...
    <p><b>Subject</b>: <input name="subject" type="text" size="30"
    maxlength="100" /></p>
