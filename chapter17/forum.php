...
$q = "SELECT t.thread_id, t.subject, username, COUNT(post_id) - 1 as responses, MAX(DATE_FORMAT
...
//echo '<p>' . $q . '</p>';         // debugging display to show the query
...
if (@mysqli_num_rows($r) > 0 ) {
    ...
    echo '<table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
        <tr>
            ...
            <td algin="center" width="10%"><em>' . $words['replies']. '</em>:</td>
...
} // end of if to check for messages in the forum
