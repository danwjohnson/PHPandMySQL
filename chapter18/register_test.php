...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form
    ...
    } // end of check for an email address
    ...
    if (preg_match('/^\w{4,20}$/', $trimmed['password1']) ) {
        ...
        } // end of check for password and confirmed password matching
        
    } else {
        
        echo '<p class="error">Please enter a valid password!</p>';
        
    } // end of check for a valid password
    ...
    if ($fn && $ln && $e && $p) {   // If everything's OK....
        ...
        if (mysqli_num_rows($r) == 0) { // Available
            ...
            if (mysqli_affected_rows($dbc) == 1) {  // If it ran OK.
                ...
                link in that email in order to activate your account.</h3>';
            ...
            link at right to ahve your password sent to you.</p>';
...
<form action="register.php" method="post">
    <fieldset>
        ...
        value="<?php if (isset($trimmed['emai'])) echo $trimmed['email']; ?>" /></p>
        ...
        <small>Use only letters, numbers, and the underscore.  Must be between 4 and 20
