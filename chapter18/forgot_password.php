...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($_POST['email'])) {
        ...
        // Check for existence of that email address...
    ...
    if ($uid) {     // If everything's OK.
        ...
        if (mysqli_affected_rows($dbc) == 1) {  // If it ran OK
            ...
            to '$p'. Please log in using this password and this email address.  Then you may
            ...
            echo '<h3>Your password has been changed.  You will receive the new, temporary password
            ...
            echo '<p class="error">Your password could not be changed due to a system error.
...
<form action="forgot_password.php" method="post">
    <fieldset>
        <p><b>Email Address:</b> <input type="text" name="email" size="20"
