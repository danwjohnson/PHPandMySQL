...
if (isset($_POST['age'])) {
    ...
    if ($age == '0-29') {
        ...
        echo '<p>Your age is recorded as under 30</p>';
        
    } elseif ($age == '30-60') {
        
        echo '<p>You age is recorded as between 30 and 60</p>';    
    
    } else {
        
        echo '<p>Your age is recorded as over 60</p>';
        
    } // end of if/else to validate the age
    
} else {    // $_POST['age] is not set
    
    $age = NULL;
    echo '<p class="error">You forgot to select age!</p>';
    
} // end of if/else to check of age was set
