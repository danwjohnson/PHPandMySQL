...
// This script takes a submitted string and checks it against a submitted
// pattern.
// This version replaces and old value with another
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Print a caption
    echo "<p>The result of replacing<br /><b>$pattern</b><br />with<br />
     $replace<br />in<br />$subject<br /><br />";
...
<form action="replace.php" method="post">
    ...
    size="40" />(include the delimiters)</p>
