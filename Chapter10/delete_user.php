...
} // end of if statement to check for valid user ID from GET or POST
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['sure'] == 'Yes' ) {
        ...
        if (mysqli_affected_rows($dbc) == 1 ) {    // If it ran OK
            ...
            echo '<p class="error">The user could not be deleted due to a
    ...
    $q = "SELECT CONCAT(last_name, ', ', first_name) FROM users WHERE
        user_id=$id";
