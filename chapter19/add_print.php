...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form
    ...
    // Validate the artist
    if (isset($_POST['artist']) && filter_var($_POST['artist'], FILTER_VALIDATE_INT,
        array('min_range' => 1)) ) {
    ...
    if (empty($errors)) {   // If everything's OK.
        ...
        if (mysqli_stmt_affected_rows($stmt) == 1 ) {
            ...
            echo '<p style="font-weight: bold; color: #C00">Your submission could not be processed
...
<form enctype="multipart/form-data" action="add_print.php" method="post">
    ...
    <p><b>Print Name:</b> <input type="text" name="print_name" size="30" maxlenght="60"
    ...
    <p><b>Price:</b> <input type="text" name="price" size="10" maxlength="10" value="<?php
