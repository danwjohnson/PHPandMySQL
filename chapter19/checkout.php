...
// Assume that the customer is logged in and that this page has access to the
// customer's ID:
$cid = 1;       // temporary
...
if (mysqli_affected_rows($dbc) == 1) {
    ...
    if ($affected == count($_SESSION['cart'])) {   // Woo hoo
        ...
        echo '<p>Thank you for your order.  You will be notified when the
        items ship.</p>';
        ...
        You will be contacted in order to have the problem fixed.  We
    ...
    echo '<p>Your order could not be processed due to a system error.  You
    will be contacted in order to have the problem fixed.  We apologize for
    the inconvenience.</p>';
