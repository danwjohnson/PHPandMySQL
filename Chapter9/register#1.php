...
// This script performs and INSERT query to add a record to the users table.
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {   // If everything's OK.
        ...
        registration_date) VALUES ('$fn', '$ln', '$e', SHA1('$p') ,
        NOW() )";
        ...
        if ($r) {   // If it ran OK
            ...
            // Public message
            echo '<h1>System Error</h1><p class="error">You could not be
        ...
        echo '<h1>Error!</h1><p class="error">The following error(s) occurred:
        <br />';
...
<form action="register.php" method="post">
    <p>First Name: <input type="text" name="first_name" size="15" maxlenght="20"
    ...
    <p>Confirm Password: <input type="password" name="pass2" size="10"
